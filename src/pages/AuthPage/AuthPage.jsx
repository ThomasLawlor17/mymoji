  ...
  const handleShowPassword = e => {
	...
	return (
		<main className="AuthPage">
          ...
          <h4>{showLogin ? "Don't have an account?" : "Already have an account?"}</h4>
					<h3 onClick={handleShowLogin}>
			...
			<div className="forms">
				{showLogin ? (
					<LoginForm setUser={setUser} showPassword={showPassword} handleShowPassword={handleShowPassword}/>
				) : (
					<SignUpForm setUser={setUser} showPassword={showPassword} handleShowPassword={handleShowPassword}/>
				)}
			</div>
		</main>
	);
